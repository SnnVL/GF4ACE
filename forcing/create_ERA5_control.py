...
ds = xc.open_mfdataset(FORCING_DIR+'era/raw/forcing_*.nc')
...
ds = xr.open_dataset(FORCING_DIR+'era/raw/forcing_2021.nc')
...
# Save forcing
ds_dec.to_netcdf(FORCING_DIR+'era/control/forcing.nc')
